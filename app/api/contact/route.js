  ...
  try {
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f8f9fa; padding: 20px; border-radius: 10px;">
        ...
        <div style="background: white; padding: 30px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
          ...
          <p style="color: #555; line-height: 1.6; margin: 20px 0;">
            ...
            or connect with me on <a href="https://www.linkedin.com/in/winning-ways/" style="color: #667eea; text-decoration: none;">LinkedIn</a>.
          </p>
          ...
          <div style="border-top: 1px solid #eee; padding-top: 20px; margin-top: 30px;">
            <p style="margin: 0; color: #888; font-size: 14px;">
              Best regards,<br>
              <strong style="color: #667eea;">Bhupender Kumar</strong><br>
    ...
    try {
      userEmailResult = await transporter.sendMail({
        from: `"Bhupender Kumar" <${process.env.GMAIL_USER}>`,
        to: email,
