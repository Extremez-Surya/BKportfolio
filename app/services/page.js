...
export default function ServicesPage() {
  ...
  const services = [
    {
      id: 1,
      title: "Wall Painting / Digital Wall Painting",
      category: "signage",
      ...
      gallery: [
        // Add your wall painting images here
        "/gallery/wall-painting/image-1.jpg",
        "https://i.postimg.cc/pr7Ch6xd/3d-rendering-flowers.jpg",
        // "/gallery/wall-painting/painting-2.jpg",
        // "/gallery/wall-painting/painting-3.jpg",
      ],
    },
    {
      id: 2,
      ...
      gallery: [
        // Add your vinyl prints images here
        // "/gallery/vinyl-prints-1.jpg",
        // "/gallery/vinyl-prints-2.jpg",
        // "/gallery/vinyl-prints-3.jpg",
      ],
    },
    {
      id: 3,
      ...
      gallery: [
        // Add your wall collage images here
    ...
    },
    {
      ...
      gallery: [
        // Add your totems images here
        // "/gallery/totems-1.jpg",
        // "/gallery/totems-2.jpg",
        // "/gallery/totems-3.jpg",
      ],
    },
    {
      id: 5,
                        ...
                        <div className="relative z-10 p-6">
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <motion.button
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                window.open("tel:+91 9891769805", "_self");
                              }}
                            >
                              Get Quote
                            </motion.button>
            ...
            <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
              ...
              >
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => window.open("tel:+91 9891769805", "_self")}
                >
                  <span>📞</span>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() =>
                    window.open("mailto:advt.cpp@gmail.com", "_self")
                  }
                >
                  <span>✉️</span>
                  Send Email
          ...
          {showServiceModal && selectedService && (
            ...
            >
              <motion.div
                ...
                className="bg-gray-900/95 backdrop-blur-xl rounded-2xl border border-gray-700/50 max-w-3xl max-h-[80vh] overflow-hidden shadow-2xl"
                onClick={(e) => e.stopPropagation()}
              >
                {/* Modal Header */}
                <div className="relative">
                  <div
                    className={`h-24 bg-gradient-to-br ${selectedService.color} relative overflow-hidden`}
                  >
                ...
                <div className="p-6">
                  ...
                  <div>
                    ...
                    selectedService.gallery.filter(image => image && !image.startsWith('//')).length > 0 ? (
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        {selectedService.gallery
                          .filter(image => image && !image.startsWith('//'))
                          .map((image, index) => (
                          <motion.div
                            key={index}
                            initial={{ opacity: 0, scale: 0.8 }}
                            ...
                            className="relative aspect-square bg-gray-800 rounded-lg overflow-hidden hover:scale-105 transition-transform duration-300 cursor-pointer"
                      ...
                      <div className="text-center py-16">
                        ...
                        <p className="text-gray-400 mb-2">
                          We're preparing amazing images for this service
                        </p>
                        <p className="text-gray-500 text-sm">
                          Contact us to see our current portfolio
                        </p>
                      </div>
                    )}
                  </div>
          ...
          {showImagePreview && selectedImage && (
            ...
            >
              ...
              >
                <button
                  onClick={closeImagePreview}
                  className="absolute top-4 right-4 z-10 w-10 h-10 bg-black/50 hover:bg-black/70 rounded-full flex items-center justify-center transition-all duration-200 backdrop-blur-sm"
                >
                  <svg
