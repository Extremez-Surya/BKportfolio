              ...
              <div className="text-center lg:text-left order-2 lg:order-1 blur-target">
                ...
                <div className="max-w-4xl mx-auto lg:mx-0 relative">
                  ...
                  >
                    ...
                    <div className="flex flex-wrap justify-center lg:justify-start gap-3">
                      <a
                        href="https://www.linkedin.com/in/winning-ways/"
                        target="_blank"
                      ...
                      <a
                        href="https://github.com/WinningWays-Surya"
                        target="_blank"
                        rel="noopener noreferrer"
                      ...
                      <a
                        href="https://www.youtube.com/@winningways2.0?sub_confirmation=1"
                        target="_blank"
                        rel="noopener noreferrer"
