...
export default function ContactPage() {
  ...
  const contactMethods = [
    {
      icon: "📞",
      title: "Phone",
      value: "+91 98917 69805",
      description: "Mon-Fri 9AM-6PM IST",
      color: "from-blue-500 to-cyan-500",
      action: () => window.open("tel:+91 9891769805", "_self"),
    },
    {
      icon: "📧",
      title: "Email",
      value: "advt.cpp@gmail.com",
      description: "Response within 24 hours",
      color: "from-purple-500 to-pink-500",
      action: () => window.open("mailto:advt.cpp@gmail.com", "_self"),
    },
    {
    ...
    },
    {
      ...
      action: () => window.open("https://wa.me/9891769805", "_blank"),
    },
  ];
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/winning-ways/",
      color: "hover:text-blue-300",
    },
    {
      icon: <YouTubeIcon size={24} />,
      name: "YouTube",
      url: "https://www.youtube.com/@winningways2.0?sub_confirmation=1",
                      ...
                      >
                        ...
                        <AnimatePresence>
                          ...
                          {submitStatus === "error" && (
                            ...
                            >
                              <span className="text-2xl mr-2">❌</span>
                              Failed to send message. Please try again or contact me directly at advt.cpp@gmail.com
                            </motion.div>
                          )}
                        </AnimatePresence>
                      </form>
            ...
            <div className="max-w-4xl mx-auto px-4 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() =>
                    window.open("https://wa.me/9891769805", "_blank")
                  }
                >
