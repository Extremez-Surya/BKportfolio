  ...
  const actions = [
    {
      ...
      action: () => window.open("mailto:advt.cpp@gmail.com?subject=Quote Request", "_blank")
    },
    {
      id: "call",
      icon: (
    ...
    },
    {
      ...
      action: () => window.open("https://wa.me/9891769805?text=Hello! I'm interested in your services.", "_blank")
    },
    {
      id: "email",
      icon: (
      ...
      action: () => window.open("mailto:advt.cpp@gmail.com", "_blank")
    },
    {
      id: "location",
      icon: (
