...
export default function Footer() {
  ...
  const contactInfo = [
    { 
      icon: "📞", 
      label: "+91 98917 69805", 
      href: "tel:+919891769805",
      color: "text-orange-400"
    },
    { 
      icon: "📧", 
      label: "advt.cpp@gmail.com", 
      href: "mailto:advt.cpp@gmail.com",
      color: "text-blue-400"
    },
    { 
      icon: "🏠", 
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-8">
        <div className="grid lg:grid-cols-2 gap-8 mb-6">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              <h3 className="text-2xl font-bold text-white mb-2">Bhupender's Portfolio</h3>
